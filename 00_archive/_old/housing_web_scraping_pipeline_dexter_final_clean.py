...
def create_schema(**kwargs):
    ...
    CREATE TABLE schema_housing.zoopla(
    ...
    DROP TABLE IF EXISTS schema_housing.dexter;
    CREATE TABLE schema_housing.dexter(
...
#     clean_dexter = pd.DataFrame.from_dict(scraped_data_previous_task)
#
...
#     # Prepare the file to send to s3
#     csv_buffer = io.StringIO()
#     clean_dexter.to_csv(csv_buffer, index=False)
#
#     # Save the pandas dataframe as a csv to s3
#     s3 = s3.get_resource_type('s3')
#
